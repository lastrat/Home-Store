                ...
                <div>
                    <div class="flex items-center gap-2 mb-3">
                        ...
                        @foreach($product->dynamic_badges as $badge)
                            ...
                            @endif
                        @endforeach
                        @if($product->stock > 0 && $product->stock <= 3 && !in_array('bientot_epuise', $product->dynamic_badges))
                    ...
                    @if($product->is_out_of_stock && auth()->check())
                        <div class="mb-6">
                            <button type="button" class="interest-btn btn btn-outline btn-sm" data-product-id="{{ $product->id }}">
