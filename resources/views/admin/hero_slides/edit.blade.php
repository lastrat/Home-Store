                ...
                <form method="POST" action="{{ route('admin.hero_slides.update', $hero_slide) }}" class="space-y-6" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="button2_text" class="form-input" value="{{ old('button2_text', $hero_slide->button2_text) }}" placeholder="Ex: Nous contacter">
                            @error('button2_text')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        <div>
                            ...
                            <input type="url" name="button2_link" class="form-input" value="{{ old('button2_link', $hero_slide->button2_link) }}" placeholder="Ex: /contact">
                            @error('button2_link')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
