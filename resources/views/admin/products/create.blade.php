        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center gap-3 mb-2">
                ...
                <div>
                    ...
                    <p class="text-gray-500">Ajoutez un nouveau produit à votre catalogue</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                    ...
                                    <div class="variant-row bg-gray-50 rounded-xl p-5 border border-gray-200" data-index="{{ $index }}">
                                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="variants[{{ $index }}][sku]" class="form-input text-sm" value="{{ $variant['sku'] ?? '' }}" placeholder="SKU">
                                            </div>
                        ...
                        <div class="card p-8">
                            ...
                            <div class="space-y-5">
                                <div>
                                    ...
                                    <textarea name="description" rows="4" class="form-input" placeholder="Décrivez le produit...">{{ old('description') }}</textarea>
                                </div>
                                <div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="url" name="video_url" class="form-input pl-10" value="{{ old('video_url') }}" placeholder="https://youtube.com/watch?v=...">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        <div class="card p-6">
                            ...
                            <div class="space-y-4">
                                <label class="flex items-center gap-3 p-3 rounded-xl border border-gray-200 hover:border-gold-300 cursor-pointer transition-colors">
                                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="w-4 h-4 rounded text-gold-600 focus:ring-gold-500">
                                    <div>
                                ...
                                <label class="flex items-center gap-3 p-3 rounded-xl border border-gray-200 hover:border-gold-300 cursor-pointer transition-colors">
                                    <input type="checkbox" name="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }} class="w-4 h-4 rounded text-gold-600 focus:ring-gold-500">
                                    <div>
                        ...
                        <div class="card p-6">
                            ...
                            <div class="aspect-video rounded-xl bg-gray-100 overflow-hidden mb-3 flex items-center justify-center">
                            ...
                            <p class="text-sm text-gray-500 text-center">Aucun aperçu disponible pour le moment</p>
                        </div>
                    </div>
                </div>
            </form>
        ...
        function addVariant() {
            ...
            div.innerHTML = `
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div>
                        <label class="block text-xs font-semibold mb-1.5 text-gray-600">SKU</label>
                        <input type="text" name="variants[${variantIndex}][sku]" class="form-input text-sm" placeholder="SKU">
                    </div>
                    <div class="flex items-end">
                        <button type="button" onclick="removeVariant(this)" class="w-full py-2 px-4 rounded-lg border border-red-200 text-red-600 hover:bg-red-50 transition-colors text-sm font-medium">
                            Supprimer
