    ...
    <section class="section bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-12">
                ...
                <a href="{{ route('admin.settings.index') }}" class="card p-6 flex items-center gap-4 hover:border-gold-300 border-2 border-transparent transition-all group">
                    ...
                    <div class="flex-1">
                        <p class="font-bold">Paramètres</p>
                        <p class="text-sm text-gray-500">Configuration du site</p>
                    </div>
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="text-gray-400 group-hover:text-gold-600 transition-colors">
                        <line x1="5" y1="12" x2="19" y2="12"></line>
                        <polyline points="12 5 19 12 12 19"></polyline>
